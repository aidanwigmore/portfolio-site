...
class AccessPasswordSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'password', 'category', 'created_at', 'expires_at', 'is_active', 'usage_logs', 'total_uses', 'is_expired']
...
class PortfolioImageSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id', 'name', 'image', 'date_taken', 'coordinates', 'camera_used', 'description', 'category', 'created_at']